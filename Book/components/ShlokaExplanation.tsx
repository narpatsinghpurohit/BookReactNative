...
interface ShlokaExplanationProps {
  shloka: Shloka;
  textSize: TextSizeType;
  onToggle?: () => void;
}

export const ShlokaExplanation: React.FC<ShlokaExplanationProps> = ({
  shloka,
  textSize,
  onToggle,
}) => {
  ...
  const explanation =
    hexToText(shloka.excryptedText4) || hexToText(shloka.excryptedText3) || '';
